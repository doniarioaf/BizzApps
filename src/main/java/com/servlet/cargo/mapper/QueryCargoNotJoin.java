...
public class QueryCargoNotJoin implements RowMapper<CargoDataNotJoin> {
    private String schemaSql;

    public QueryCargoNotJoin() {
    ...
    @Override
    public CargoDataNotJoin mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        CargoDataNotJoin data = new CargoDataNotJoin();
        data.setId(id);
