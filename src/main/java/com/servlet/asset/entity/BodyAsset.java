...
public class BodyAsset {
	...
	private Long kepala_masaberlakustnk;
	private String kepala_kir;
	private Long kepala_masaberlakukir;
	private Long kepala_lunastanggal;
	...
	public Long getKepala_masaberlakustnk() {
		return kepala_masaberlakustnk;
	}
	public void setKepala_masaberlakustnk(Long kepala_masaberlakustnk) {
	...
	public Long getKepala_masaberlakukir() {
		return kepala_masaberlakukir;
	}
	public void setKepala_masaberlakukir(Long kepala_masaberlakukir) {
		this.kepala_masaberlakukir = kepala_masaberlakukir;
	}
	public Long getKepala_lunastanggal() {
		return kepala_lunastanggal;
	}
	public void setKepala_lunastanggal(Long kepala_lunastanggal) {
	...
	public Long getBuntut_masaberlakukir() {
		return buntut_masaberlakukir;
	}
	public void setBuntut_masaberlakukir(Long buntut_masaberlakukir) {
	...
	public Long getBuntut_lunastanggal() {
		return buntut_lunastanggal;
	}
	public void setBuntut_lunastanggal(Long buntut_lunastanggal) {
