...
public class AssetData {
	...
	private String kepala_jeniskendaraanname;
	...
	private String sparepartkepala_bearing_posisibearingname;
	private String sparepartkepala_bearing_merk;
	private String sparepartkepala_bearing_jenishole;
	private String sparepartkepala_bearing_jenisholename;
	private String sparepartkepala_bearing_kotakbulat;
	private String sparepartkepala_bearing_kotakbulatname;
	...
	private String sparepartkepala_ban_posisiname;
	private String sparepartkepala_ban_jenis;
	private String sparepartkepala_ban_jenisname;
	private String sparepartkepala_ban_ukuran;
	private String sparepartkepala_ban_ukuranname;
	private String sparepartkepala_ban_status;
	private String sparepartkepala_ban_statusname;
	...
	private String sparepartbuntut_jenisname;
	...
	private String sparepartbuntut_bearing_posisiname;
	private String sparepartbuntut_bearing_merk;
	private String sparepartbuntut_bearing_jenishole;
	private String sparepartbuntut_bearing_jenisholename;
	private String sparepartbuntut_bearing_kotakbulat;
	private String sparepartbuntut_bearing_kotakbulatname;
	...
	private String sparepartbuntut_ban_posisiname;
	private String sparepartbuntut_ban_jenis;
	private String sparepartbuntut_ban_jenisname;
	private String sparepartbuntut_ban_ukuran;
	private String sparepartbuntut_ban_ukuranname;
	...
	public void setSparepartbuntut_jenisname(String sparepartbuntut_jenisname) {
		this.sparepartbuntut_jenisname = sparepartbuntut_jenisname;
	}
	public String getSparepartbuntut_bearing_posisiname() {
		return sparepartbuntut_bearing_posisiname;
	}
	public void setSparepartbuntut_bearing_posisiname(String sparepartbuntut_bearing_posisiname) {
		this.sparepartbuntut_bearing_posisiname = sparepartbuntut_bearing_posisiname;
	}
	public String getSparepartbuntut_bearing_jenisholename() {
		return sparepartbuntut_bearing_jenisholename;
	}
	public void setSparepartbuntut_bearing_jenisholename(String sparepartbuntut_bearing_jenisholename) {
		this.sparepartbuntut_bearing_jenisholename = sparepartbuntut_bearing_jenisholename;
	}
	public String getSparepartbuntut_bearing_kotakbulatname() {
		return sparepartbuntut_bearing_kotakbulatname;
	}
	public void setSparepartbuntut_bearing_kotakbulatname(String sparepartbuntut_bearing_kotakbulatname) {
		this.sparepartbuntut_bearing_kotakbulatname = sparepartbuntut_bearing_kotakbulatname;
	}
	public String getSparepartbuntut_ban_posisiname() {
		return sparepartbuntut_ban_posisiname;
	}
	public void setSparepartbuntut_ban_posisiname(String sparepartbuntut_ban_posisiname) {
		this.sparepartbuntut_ban_posisiname = sparepartbuntut_ban_posisiname;
	}
	public String getSparepartbuntut_ban_jenisname() {
		return sparepartbuntut_ban_jenisname;
	}
	public void setSparepartbuntut_ban_jenisname(String sparepartbuntut_ban_jenisname) {
		this.sparepartbuntut_ban_jenisname = sparepartbuntut_ban_jenisname;
	}
	public String getSparepartbuntut_ban_ukuranname() {
		return sparepartbuntut_ban_ukuranname;
	}
	public void setSparepartbuntut_ban_ukuranname(String sparepartbuntut_ban_ukuranname) {
		this.sparepartbuntut_ban_ukuranname = sparepartbuntut_ban_ukuranname;
	}
	public String getSparepartbuntut_ban_statusname() {
		return sparepartbuntut_ban_statusname;
	}
	public void setSparepartbuntut_ban_statusname(String sparepartbuntut_ban_statusname) {
		this.sparepartbuntut_ban_statusname = sparepartbuntut_ban_statusname;
	}
	public String getSparepartkepala_bearing_posisibearingname() {
		return sparepartkepala_bearing_posisibearingname;
	}
	public void setSparepartkepala_bearing_posisibearingname(String sparepartkepala_bearing_posisibearingname) {
		this.sparepartkepala_bearing_posisibearingname = sparepartkepala_bearing_posisibearingname;
	}
	public String getSparepartkepala_jenisname() {
		return sparepartkepala_jenisname;
	}
	public void setSparepartkepala_jenisname(String sparepartkepala_jenisname) {
		this.sparepartkepala_jenisname = sparepartkepala_jenisname;
	}
	public String getSparepartkepala_bearing_jenisholename() {
		return sparepartkepala_bearing_jenisholename;
	}
	public void setSparepartkepala_bearing_jenisholename(String sparepartkepala_bearing_jenisholename) {
		this.sparepartkepala_bearing_jenisholename = sparepartkepala_bearing_jenisholename;
	}
	public String getSparepartkepala_bearing_kotakbulatname() {
		return sparepartkepala_bearing_kotakbulatname;
	}
	public void setSparepartkepala_bearing_kotakbulatname(String sparepartkepala_bearing_kotakbulatname) {
		this.sparepartkepala_bearing_kotakbulatname = sparepartkepala_bearing_kotakbulatname;
	}
	public String getSparepartkepala_ban_posisiname() {
		return sparepartkepala_ban_posisiname;
	}
	public void setSparepartkepala_ban_posisiname(String sparepartkepala_ban_posisiname) {
		this.sparepartkepala_ban_posisiname = sparepartkepala_ban_posisiname;
	}
	public String getSparepartkepala_ban_jenisname() {
		return sparepartkepala_ban_jenisname;
	}
	public void setSparepartkepala_ban_jenisname(String sparepartkepala_ban_jenisname) {
		this.sparepartkepala_ban_jenisname = sparepartkepala_ban_jenisname;
	}
	public String getSparepartkepala_ban_ukuranname() {
		return sparepartkepala_ban_ukuranname;
	}
	public void setSparepartkepala_ban_ukuranname(String sparepartkepala_ban_ukuranname) {
		this.sparepartkepala_ban_ukuranname = sparepartkepala_ban_ukuranname;
	}
	public String getSparepartkepala_ban_statusname() {
		return sparepartkepala_ban_statusname;
	}
	public void setSparepartkepala_ban_statusname(String sparepartkepala_ban_statusname) {
		this.sparepartkepala_ban_statusname = sparepartkepala_ban_statusname;
	}
	public String getKepala_jeniskendaraanname() {
		return kepala_jeniskendaraanname;
	}
	public void setKepala_jeniskendaraanname(String kepala_jeniskendaraanname) {
		this.kepala_jeniskendaraanname = kepala_jeniskendaraanname;
	}
	public Long getId() {
		return id;
	}
	...
	public String getBuntut_rangkaname() {
		return buntut_rangkaname;
	}
	public void setBuntut_rangkaname(String buntut_rangkaname) {
		this.buntut_rangkaname = buntut_rangkaname;
	}
	public String getBuntut_jenisaxelname() {
		return buntut_jenisaxelname;
	}
	public void setBuntut_jenisaxelname(String buntut_jenisaxelname) {
		this.buntut_jenisaxelname = buntut_jenisaxelname;
	}
	public String getBuntut_jenisholename() {
		return buntut_jenisholename;
	}
	public void setBuntut_jenisholename(String buntut_jenisholename) {
		this.buntut_jenisholename = buntut_jenisholename;
	}
	public List<HistoryAssetMappingData> getHistorymapping() {
		return historymapping;
	}
	public void setHistorymapping(List<HistoryAssetMappingData> historymapping) {
		this.historymapping = historymapping;
	}
	public List<AssetMappingData> getAssetmapping() {
		return assetmapping;
	}
	public void setAssetmapping(List<AssetMappingData> assetmapping) {
