...
public class ConstansPermission {
	...
	public static final String CREATE_STOCK_PRODUCT = "CREATE_STOCK_PRODUCT";
	public static final String CREATE_REJECT_STOCK_PRODUCT = "CREATE_REJECT_STOCK_PRODUCT";
}
