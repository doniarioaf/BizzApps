...
public class QueryInvoiceReportPiutang implements RowMapper<InvoiceDataReportPiutang> {
    private String schemaSql;

    public QueryInvoiceReportPiutang() {
    ...
    @Override
    public InvoiceDataReportPiutang mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        InvoiceDataReportPiutang data = new InvoiceDataReportPiutang();
        data.setId(id);
