...
public class QueryProductDetail implements RowMapper<ProductDataDetail> {
    ...
    @Override
    public ProductDataDetail mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        ProductDataDetail data = new ProductDataDetail();
        data.setId(id);
        data.setNama(nama);
        data.setSku(sku);
