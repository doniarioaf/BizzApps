...
public class GetProductAllColumn implements RowMapper<ProductData>{
private String schemaSql;
	
	public GetProductAllColumn() {
		...
		sqlBuilder.append("data.conv1to4 as conv1to4, data.conv2to4 as conv2to4, data.conv3to4 as conv3to4, data.conv4to4 as conv4to4, data.image as image, data.barcode as barcode ");
