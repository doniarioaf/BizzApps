...
public class GetDetailWorkOrderForReportStatusInvoice implements RowMapper<DetailWorkOrderData>{
	private String schemaSql;
	
	public GetDetailWorkOrderForReportStatusInvoice() {
		...
		sqlBuilder.append("data.barang as barang, ");
		sqlBuilder.append("sj.id as idsuratjalan , sj.nodocument as nodocumentsj, sj.tanggal as tanggalsj, sj.tanggalkembali as tanggalkembalisj, sj.lembur as lembursj ");
